...
public class SmartUserMessages {
	...
	public String toString() {
		return "SmartUserMessages [id=" + id + ", name=" + name + ", email=" + email + ", phone=" + phone
				+ ", avatarurl=" + avatarurl + ", password=" + password + ", mibo_phone=" + mibo_phone
				+ ", standby_email=" + standby_email + ", role_name=" + role_name + "]";
	}
}
