...
@Api(tags="关于用户角色及其资源的Controller")
@RestController
public class DisplayResourceController {
	...
	@ApiOperation(value="查找所有页面资源信息",notes="查找所有页面资源信息")
	@GetMapping("/Allresource")
	public Response<List> getAllResource(){
		return Response.ok(service.findAllResource());
	}
}
